...
class MerkleProof:
    """The Merkle Proof to be provided to a verifier to 
       prove whether the leaf is at position pos of the 
       Merkle Tree."""
    def __init__(self, leaf, pos, hashes):
        ...
        self.hashes = hashes # the hashes from bottom to the top of tree to
                             # prove the leaf is part of the Merkle Tree


##  The hash prefixes in the two functions below are a security measure.
